			...
			<div class="col-9">
				<div class="card">
    				<div class="header text-center">
        				<h6 class="primary">Welcome</h6>
    				</div>
    				<div class="body">
        			<h5 class="primary">Worklist</h5>
        			<p>Worklist is a project management system based on the fundaments of the Agile/Scrum workflow.</p>
        			<p>The application provides a quick overview of the tasks at hand and an resource management/scheduling system.</p>
        			<br><br>
        			<p>Be creative, be productive!</p>
    				</div>
    				<div class="footer">
